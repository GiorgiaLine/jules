...
SUBROUTINE calc_n_comps_triffid(l, n, phen, lai_bal,                           &
                                ! leaf,
                                wood, root, n_leaf,                            &
                                n_root, n_stem, dvi_cpft)
                                ! GL CNP_PHOS plant_growth changes
...
INTEGER             ::                                                         &
  ...
  , st_int   ! The number of soil type
...
, st_real                                                                      &
! The number of soil type - GL CNP_PHOS Initialised as real?
!!! GL CNP_PHOS Move back to L66 once veg science done
, leaf                                                                         &
             ! Leaf carbon (kg C m-2)
!!! GL CNP_PHOS Move back to L86 once veg science done
, p_leaf                                                                       &
